...
@interface ImageBrowserTranslation ()

@end

@implementation ImageBrowserTranslation
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    ImageBrowserModel * currentModel = [dataM objectAtIndex:currentIndex];
